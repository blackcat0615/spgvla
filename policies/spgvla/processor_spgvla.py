...
def make_spgvla_pre_post_processors(
    config: SpgVLAConfig,
...
@ProcessorStepRegistry.register(name="spgvla_new_line_processor")
class SpgVLANewLineProcessor(ComplementaryDataProcessorStep):
    """
