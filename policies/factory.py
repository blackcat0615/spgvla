...
from .spgvla.configuration_spgvla import SpgVLAConfig
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from .spgvla.modeling_spgvla import SpgVLAPolicy
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, SpgVLAConfig):
        
        from .spgvla.processor_spgvla import make_spgvla_pre_post_processors

        processors = make_spgvla_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
