...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def _get_query_indices(
        ...
        progress = 1.0 * (abs_idx-ep_start)/(ep_end-ep_start)
        return query_indices, padding, progress
    ...
    def __getitem__(self, idx) -> dict:
        ...
        if self.delta_indices is not None:
            query_indices, padding, progress = self._get_query_indices(abs_idx, ep_idx)
