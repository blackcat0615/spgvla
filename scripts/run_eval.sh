...
# 基础参数配置
POLICY_TYPE="spgvla"
POLICY_PATH="/root/gpufree-data/lehome/outputs/train/spgvla_exp8_pg_bs_64/checkpoints/last/pretrained_model"
...
# scenarios=("pant_long" "pant_short")
# scenarios=("top_long" "top_short")
# 循环执行评测
