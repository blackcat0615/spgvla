...
from eval_policy import PolicyRegistry
from eval_policy.base_policy import BasePolicy
from lehome_datasets.lerobot_dataset import LeRobotDataset
...
def eval(args: argparse.Namespace, simulation_app: Any) -> None:
    ...
    logger.info(f"available_policies: {available_policies}")
    ...
    if args.policy_type == "lerobot" or args.policy_type == "spgvla":
