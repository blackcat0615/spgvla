...
from utils.eval_utils import preprocess_observation
...
@PolicyRegistry.register("spgvla")
class SpgVLAPolicy(BasePolicy):
    """
    Adapter class for official LeRobot policies (ACT, Diffusion, SmolVLA, etc.).
    ...
    def __init__(
        ...
        from policies.spgvla.configuration_spgvla import SpgVLAConfig
        ...
        # 2. Load Policy Config
        policy_cfg = PreTrainedConfig.from_pretrained(policy_path, cli_overrides={})
        # policy_cfg = SpgVLAConfig.from_pretrained(policy_path, cli_overrides={})
        policy_cfg.pretrained_path = policy_path
